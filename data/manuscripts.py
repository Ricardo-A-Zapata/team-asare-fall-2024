...
# def author_withdraw(manuscript_id: str, author_email: str)
#   -> Optional[dict]:
...
# def reject_manuscript(manuscript_id: str, actor_email: str)
#   -> Optional[dict]:
#     """
...
# def accept_manuscript(manuscript_id: str, actor_email: str)
#   -> Optional[dict]:
#     """
